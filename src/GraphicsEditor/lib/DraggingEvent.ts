...
export class DraggingEvent {
  ...
  public constructor(
    ...
    this.lastMousePosition = new Position(
  ...
  public setLastEvent(event: MouseEvent): void {
    ...
    this.nextPosition = new Position(
      this.initialShapePosition.x -
        this.canvasDimensions.left +
        this.distanceMoved.x -
        this.mouseOffset.x,
      this.initialShapePosition.y -
        this.canvasDimensions.top +
  ...
  public get distanceMoved(): Position {
    const distanceMovedX =
      this.lastMousePosition.x - this.initialShapePosition.x;
    const distancedMovedY =
      this.lastMousePosition.y - this.initialShapePosition.y;
